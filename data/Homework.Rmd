#441 Reproducibility and Statistics Assignment 
...
I'd like to find the minimum, mean, and median incomes.  This can all be done
in one fell dinosaur swoop.
...
Although, we shouldn't make a line graph for these data, it
